const resultPlaces = [
    ...
    },
    {
        id: 14,
        name: "Szkocja",
        description: "Szkocja to surowa, ale wyjątkowo piękna część północnej Europy, która oczaruje każdego, kto da się zwabić w jej ramiona. W trakcie wycieczki do Szkocji każdy dzień możesz zacząć leniwie przechadzając się po małym portowym miasteczku, w południe stanąć na jednym ze szczytów podziwiając zapierającą dech w piersiach panoramę Highlandów, a wieczorem stojąc wśród ruin średniowiecznego zamku podziwiać zachód słońca nad Loch’em (po gaelicku oznacza jezioro).",
